...
public class DeletePostServiceLocator extends org.apache.axis.client.Service implements main_pkg.DeletePostService {
    ...
    private java.lang.String deletePost_address = "http://localhost:8080/magazine/services/deletePost";
    ...
    public main_pkg.DeletePost getdeletePost() throws javax.xml.rpc.ServiceException {
    ...
    public main_pkg.DeletePost getdeletePost(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            main_pkg.DeletePostSoapBindingStub _stub = new main_pkg.DeletePostSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (main_pkg.DeletePost.class.isAssignableFrom(serviceEndpointInterface)) {
                main_pkg.DeletePostSoapBindingStub _stub = new main_pkg.DeletePostSoapBindingStub(new java.net.URL(deletePost_address), this);
                _stub.setPortName(getdeletePostWSDDServiceName());
                return _stub;
            }
        }
